...
class DoubleDQNAgent:
    ...
    def save_trained_results(self, output_dir: Union[str, os.PathLike] = None,
                             model_name: str = "double_dqn_model", best_model: dict = None) -> str:
        """
...
class CartPoleDoubleDqnAgent(DoubleDQNAgent):
    ...
    def __init__(self, input_type: str, **kwargs):
        ...
        """
        try:
            super(CartPoleDoubleDqnAgent, self).__init__(
    ...
    def train_double_dqn_batch(self, batch) -> float:
    ...
    def run(self, output_dir: Union[str, os.PathLike] = None) -> None:
        ...
        for episode_num in pbar:
            ...
            while True:
                ...
                if t_total % self.policy_update == 0:
                    ...
                    loss = self.train_double_dqn_batch(batch)
        ...
        # Save the model
        dump_loc = self.save_trained_results(output_dir, "double_dqn_model_" + self.input_type, best_model=best_model)
